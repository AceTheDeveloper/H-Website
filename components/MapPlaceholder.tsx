export default function MapPlaceholder() {
  return (
    <div className="relative aspect-[4/3] w-full overflow-hidden border border-sand bg-sand/40 md:aspect-auto md:h-full md:min-h-[440px]">
      <iframe
        title="Map showing H Breakfast to Bar on Diversion Road, Mandurriao, Iloilo City"
